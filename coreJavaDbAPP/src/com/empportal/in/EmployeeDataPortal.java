...
public class EmployeeDataPortal {

		public static void main(String[] args) throws ClassNotFoundException, SQLException {
			Scanner sc= new Scanner(System.in);
			Connection con=ConnectionClass.getConnect();
			System.out.println("welcome Employee Portal");
			...
			case 3:	
			   {
				   try {
					   ...
					   String address=sc.next();
						...
						PreparedStatement ps=con.prepareStatement("update employeedata set esalary=?,address=? where empid=?;");
						ps.setInt(1, esalary);
			...
			case 4:	
			   {
				   try {
					   System.out.println("enter empid");
					   int id=sc.nextInt();
				   PreparedStatement ps=con.prepareStatement("delete from employeedata where empid=?;");
					ps.setInt(1, id);
					int i=ps.executeUpdate();
					if(i!=0)

...
response.setContentType("text/html");
		...
		PreparedStatement ps=con.prepareStatement("insert into managerregister(name,gender,mobile,mail,password,department) values(?,?,?,?,?,?)");
		ps.setString(1, name);
		...
		{
			response.sendRedirect("managerregister.html");
		}
